<template>
    <form class="contact-form" >
        ...
        <div class="form-group">
            <label for="msg-name">Fullname</label>
            <input type="text" id="msg-name" class="form-control" v-model="Item.fullname">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea rows="3" id="msg-message" class="form-control" v-model="Item.note"></textarea>
        </div>
