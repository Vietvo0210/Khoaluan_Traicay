<template>
  ...
  <nav class="sidebar bg-white dark:bg-gray-800">
    ...
    <div class="sidebar-head p-4">
      <router-link to="/" exact>
        <h2
          ...
          translate="no"
        >
          ADMIN<span class="text-primary">.</span>
          <span
    ...
    <div class="sidebar-list p-4 mt-4">
      <p class="font-medium text-gray-400 dark:text-gray-600">Quản Lý</p>
      <div class="wrap-item mt-4 dark:text-gray-500">
        ...
        <div class="item mt-3">
          <menu-accordion>
            ...
            <template v-slot:title> Tài Khoản </template>
            <template v-slot:content>
              <button
      ...
      <div class="item mt-3">
        <router-link to="/">
          ...
          >
            ...
            <span class="w-full"> Đơn Hàng </span>
      ...
      <div class="item mt-3">
        <router-link to="/">
          ...
          >
            ...
            <span class="w-full"> Báo Cáo </span>
            <span class="box-border mt-1 text-gray-500"> </span>
          </button>
        </router-link>
      </div>
      <div class="item mt-3">
        <router-link to="/">
          ...
          >
            <span class="mr-3 text-xl"><Icon icon="carbon:data-table" /></span>
            <span class="w-full"> Doanh Thu </span>
            <span class="box-border mt-1 text-gray-500"> </span>
          </button>
        </router-link>
      </div>
